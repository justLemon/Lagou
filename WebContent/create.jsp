		...
		<div id="header">
			<div class="wrapper">
				...
				<ul id="navheader" class="reset">
					...
					<li class="current"><a href="create.jsp" rel="nofollow">发布职位</a></li>
					...
					<dd>
						<form action="preview.html"
							...
							<input type="hidden" value="" name="id"> <input
								...
								type="hidden" value="<%= company==null?"": company.getCompanyId()  %>" name="companyId"> <input
									...
									<tr>
										...
										<td>
											...
											<textarea name="positionDetail" id="positionDetail"
												class="tinymce"  aria-hidden="true"></textarea></td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										<td>工作地址</td>
