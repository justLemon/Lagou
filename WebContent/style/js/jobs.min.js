...
$(function() {
    function a() {
        ...
        s = $("#resubmitToken").val(),
        $.ajax({
            url: "position/savePosition.json",
            type: "POST",
            data: {
                positionType: a,
                positionName: b,
            ...
            a.success ? window.location.href = a.content : "" != a.content && null != a.content ? window.location.href = a.content : $("#beError").html(a.msg).show()
        }))
    }
    $("#telForm").validate({
        rules: {
