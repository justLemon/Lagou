            ...
            $(this).validate({
                ...
                submitHandler: function(a) {
                    ...
                    $.ajax({
                        ...
                        e = "",
                        3 == b.code ? "" != c ? (e += '<li data-id="' + c.projectid + '">',
                        e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' + c.projectName + '" data-posName="' + c.positionName + '" data-startY="' + c.startYear + '" data-startM="' + c.startMonth + '" data-endY="' + c.endYear + '"' + 'data-endM="' + c.endMonth + '">' + c.projectName + '/' + c.positionName + '<span class="c9">（' + c.startYear + '/' + c.startMonth + "-" + (c.endYear == '至今'?c.endYear:(c.endYear + '/'+ c.endMonth) )+ "）</span></div>",
                        ...
                        $("#lastChangedTime span").text(new Date().toLocaleString()),
                        k(d.obj),
    ...
    $("#profileForm").validate({
        ...
        submitHandler: function(a) {
            var b = $('input[name="name"]', a).val()
              ...
              , i = $("#pageType").val()
              , j = $("#resumeId").val()
              , l = $("#resubmitToken").val(),x;
            $("#nameVal").val(b),
            $("#genderVal").val(c),
            $("#topDegreeVal").val(d),
            $("#workyearVal").val(e),
            $("#currentStateVal").val(f),
            $("#emailVal").val(g),
            $("#telVal").val(h),
            $("#lastChangedTime span").text(new Date().toLocaleString()),
            x = b,
            ...
            "" != d && (x += " | " + d),
            x += " | " + e + "<br />" + h + " | " + g + "<br />" + f,
            $("#basicInfo .basicShow span").html(x),
            $(a).find(":submit").val("保存中...").attr("disabled", !0),
            $.ajax({
                ...
                $("#basicInfo .basicShow span").parent().removeClass("dn"),
              ...
              //  $("#lastChangedTime span").text(b.content.refreshTime),
                ...
                scoreChange(b.content.infoCompleteScore),
    ...
    $("#expectForm").validate({
        ...
        submitHandler: function(a) {
            var c = $('input[name="expectCity"]', a).val()
              ...
              , g = $("#resumeId").val()
              , h = $("#resubmitToken").val();
              b.obj.find("#expectJobVal").val(e),
              b.obj.find("#expectCityVal").val(c),
              b.obj.find("#typeVal").val(d),
              b.obj.find("#expectPositionVal").val(e),
              b.obj.find("#expectSalaryVal").val(f),
              b.expectJobVal = e,
              b.expectCityVal = c,
              b.typeVal = d,
              b.expectPositionVal = e,
              b.expectSalaryVal = f,
            $(a).find(":submit").val("保存中...").attr("disabled", !0),
            $.ajax({
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    b.success) {
                        ...
                        e = "",
                        f = 0; f < d.length; f++)
                            e += 0 == f % 2 ? '<li data-id="' + d[f].expid + '" class="clear">' : '<li data-id="' + d[f].expid + '">',
                            e += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startYear="' + d[f].startYear + '" data-endYear="' + d[f].endYear + '" data-startMonth = "' + d[f].startMonth + '" data-endMonth = "' + d[f].endMonth + '">' + d[f].startYear + "/" + d[f].startMonth+ "-" + d[f].endYear + "/" + d[f].endMonth  + "</span>" + "<div>" + '<img src="' + ctx + "/" + d[f].companyLogo + '" width="56" height="56" alt="' + d[f].companyName + '" />' + "<h3>" + d[f].positionName + "</h3>" + "<h4>" + d[f].companyName + "</h4>" + "</div>" + "</li>";
            ...
            submitHandler: function(a) {
                ...
                $.ajax({
                    ...
                    b.success) {
                        ...
                        d = "",
                        e = 0; e < c.length; e++)
                            d += 0 == e % 2 ? '<li data-id="' + c[e].eduid + '" class="clear">' : '<li data-id="' + c[e].eduid + '">',
                            d += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startY="' + c[e].startYear + '" data-endY="' + c[e].endYear + '">' + c[e].startYear + "-" + c[e].endYear + "</span>" + "<div>" + '<h3 data-schName="' + c[e].schoolName + '">' + c[e].schoolName + "</h3>" + '<h4 data-proName="' + c[e].professional + '" data-degree="' + c[e].education + '">' + c[e].education + "，" + c[e].professional + "</h4>" + "</div>" + "</li>";
...
$(window).load(function() {
	$("#expectForm .btn_profile_cancel").click();
	$("#selfDescription .btn_profile_cancel").click();
